...
--
    INSERT INTO personaggi (
        idPersonaggio, Nome, Razza, Classe, Classi_Secondarie,
        Allineamento, Livello, Livelli_Secondari, Esperienza,
        Ferite, MaxPuntiFerita, Origine, Famiglia,
        Stirpe_Clan, Religione, Classe_Sociale, Fratelli_Sorelle,
        Sesso, Anni, Altezza, Peso,
        Capelli, Occhi, Aspetto
    ) VALUES (
        pIdPersonaggio, pNome, pRazza, pClasse, pClassi_Secondarie,
        pAllineamento, pLivello, pLivelli_Secondari, pEsperienza,
        pFerite, pMaxPuntiFerita, pOrigine, pFamiglia,
    ...
    if lvDuplicatedKey = 1 then
        UPDATE personaggi
           SET Nome = pNome,
               ...
               Ferite = pFerite,
               MaxPuntiFerita = pMaxPuntiFerita,
               Origine = pOrigine,
               Famiglia = pFamiglia,
