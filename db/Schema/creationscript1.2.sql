...
CREATE  TABLE IF NOT EXISTS `adndproject`.`personaggi` (
  ...
  `Razza` INT NOT NULL ,
  `Classe` INT NOT NULL ,
  `Allineamento` INT NOT NULL ,
  `Livello` INT NOT NULL DEFAULT 1 ,
  `Esperienza` INT NOT NULL DEFAULT 0 ,
  `PuntiFerita` INT NOT NULL DEFAULT 0 ,
  `MaxPuntiFerita` INT NOT NULL DEFAULT 0 ,
  `ClasseArmatura` INT NOT NULL DEFAULT 10 ,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `adndproject`.`pg_tirosalv` ;
...
CREATE INDEX `fk_pgtv_idPersonaggio` ON `adndproject`.`pg_tirosalv` (`idPersonaggio` ASC) ;

CREATE INDEX `fk_pgtv_idTiroSalvezza` ON `adndproject`.`pg_tirosalv` (`idTiroSalvezza` ASC) ;
...
SET AUTOCOMMIT=0;
USE `adndproject`;
INSERT INTO `adndproject`.`allineamento` (`idAllineamento`, `Tipologia`, `Sigla`) VALUES ('1', 'Legale Buono', 'LB');
INSERT INTO `adndproject`.`allineamento` (`idAllineamento`, `Tipologia`, `Sigla`) VALUES ('2', 'Legale Neutrale', 'LN');
INSERT INTO `adndproject`.`allineamento` (`idAllineamento`, `Tipologia`, `Sigla`) VALUES ('3', 'Legale Malvagio', 'LM');
INSERT INTO `adndproject`.`allineamento` (`idAllineamento`, `Tipologia`, `Sigla`) VALUES ('4', 'Neutrale Buono', 'NB');
INSERT INTO `adndproject`.`allineamento` (`idAllineamento`, `Tipologia`, `Sigla`) VALUES ('5', 'Neutrale Puro', 'NP');
INSERT INTO `adndproject`.`allineamento` (`idAllineamento`, `Tipologia`, `Sigla`) VALUES ('6', 'Neutrale Malvagio', 'NM');
INSERT INTO `adndproject`.`allineamento` (`idAllineamento`, `Tipologia`, `Sigla`) VALUES ('7', 'Caotico Buono', 'CB');
INSERT INTO `adndproject`.`allineamento` (`idAllineamento`, `Tipologia`, `Sigla`) VALUES ('8', 'Caotico Neutrale', 'CN');
INSERT INTO `adndproject`.`allineamento` (`idAllineamento`, `Tipologia`, `Sigla`) VALUES ('9', 'Caotico Malvagio', 'CM');
