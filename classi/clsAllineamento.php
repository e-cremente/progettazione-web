<?php
    class clsAllineamento {
        //Proprietà private
        private $m_idAllineamento;
        private $m_Tipologia;
        //RELAZIONI: PADRI
        //RELAZIONI: FIGLI
        ...
        public function __construct($pDBRow = null, $pPrfx = '')
        {
            ...
            $this->m_idAllineamento = $pDBRow["{$pPrfx}idAllineamento"];
            $this->m_Tipologia = $pDBRow["{$pPrfx}Tipologia"];
        }
        // }}}
        ...
        {
            $lvRes = [
                'idAllineamento'=>$this->m_idAllineamento,
                'Tipologia'=>$this->m_Tipologia,
            ];
            return $lvRes;
        }
        // }}}
