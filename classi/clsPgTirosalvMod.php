<?php
	class clsPgTirosalvMod{
		...
		public function __get($pProperty)
        {
            ...
            if ($pProperty == 'tirosalvezza') {
                if ($this->m_abilita == null) {
                    $this->m_abilita = new clsTiroSalvezza(selTiroSalvezza($this->m_idTiroSalvezza));
                }
        ...
        function setInsertStmt(){
            $this->insertstmt = "INSERT INTO pg_tirosalv_mod "
                               .     "VALUES ({$this->m_idPersonaggio}, {$this->m_idTiroSalvezza}, ". ($this->m_Modificatore == '' ? 'NULL' : $this->m_Modificatore) . ")";
        }
	}