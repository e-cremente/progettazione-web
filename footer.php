		...
		<footer id="footer">
			<p class="parcentro" id="webmaster">
				<strong>Web Master</strong>: Edoardo Cremente
			<br>
				Si prega di non copiare o distribuire materiale estrapolato dal sito senza previa autorizzazione
			<br>
				Per contatti:
			<br>
